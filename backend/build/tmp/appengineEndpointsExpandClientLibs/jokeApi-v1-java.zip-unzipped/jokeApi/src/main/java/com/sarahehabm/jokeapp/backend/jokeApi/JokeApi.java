 ...
 * on 2016-02-21 at 23:01:15 UTC 
 * Modify at your own risk.
 */

package com.sarahehabm.jokeapp.backend.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://joketeller2-1227.appspot.com/_ah/api/";
  ...
  public class GetJoke extends JokeApiRequest<com.sarahehabm.jokeapp.backend.jokeApi.model.Joke> {
    ...
    protected GetJoke(java.lang.Long id) {
      super(JokeApi.this, "GET", REST_PATH, null, com.sarahehabm.jokeapp.backend.jokeApi.model.Joke.class);
   ...
   *
   * @param content the {@link com.sarahehabm.jokeapp.backend.jokeApi.model.Joke}
   * @return the request
   */
  public InsertJoke insertJoke(com.sarahehabm.jokeapp.backend.jokeApi.model.Joke content) throws java.io.IOException {
    InsertJoke result = new InsertJoke(content);
    initialize(result);
    return result;
  }

  public class InsertJoke extends JokeApiRequest<com.sarahehabm.jokeapp.backend.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected InsertJoke(com.sarahehabm.jokeapp.backend.jokeApi.model.Joke content) {
      super(JokeApi.this, "POST", REST_PATH, content, com.sarahehabm.jokeapp.backend.jokeApi.model.Joke.class);
    }
